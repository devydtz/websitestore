...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  ...
  const system = [
    ...
    "Understand casual slang, shorthand, typos, and messy admin messages. Infer the likely meaning before asking for clarification.",
    "Answer a wide range of topics like a general assistant: coding, Minecraft, business, school, writing, planning, troubleshooting, math, research, and normal conversation.",
    ...
    "If the topic can be answered with safe general knowledge, answer it even when no Lunaris-specific context exists.",
    "If live/current/private facts are needed and no tool result is available, say what access is missing in one short sentence.",
    ...
    "For vague but conversational messages like 'fixing' or 'we are gonna fix', respond to the intent naturally instead of giving a canned greeting.",
