...
import { LunarisCorePanel } from "./LunarisCorePanel";
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-5 z-[80] group flex items-center gap-3 rounded-full border border-purple-200/25 bg-[#10071f]/90 px-4 py-3 text-sm font-black text-purple-50 shadow-2xl shadow-purple-600/30 backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-purple-100/55 hover:bg-purple-950"
      ...
      <LunarisCorePanel open={open} onClose={() => setOpen(false)} />
    </>
  );
}
